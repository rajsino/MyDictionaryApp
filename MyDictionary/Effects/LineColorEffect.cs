...
namespace MyDictionary.Effects
{
	public static class LineColorEffect
	{
		...
		{
			public EntryLineColorEffect() : base("MyDictionary.EntryLineColorEffect")
			{
			}
		}
		...
		{
			public DatePickerLineColorEffect() : base("MyDictionary.DatePickerLineColorEffect")
			{
			}
		}
		...
		{
			public PickerLineColorEffect() : base("MyDictionary.PickerLineColorEffect")
			{
			}
		}
	}
